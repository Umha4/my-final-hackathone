...
const ProductPage = () => {
  ...
  const [currentImage, setCurrentImage] = useState<string>(""); // Initialize with an empty string
  ...
  useEffect(() => {
    async function fetchProduct() {
      try {
        console.log("Fetching product with slug:", id); // Debugging
        ...
        if (product?.image) {
          ...
          if (imageUrl) {
            ...
            console.error("Invalid image URL generated by urlFor");
            setCurrentImage("/path/to/fallback/image.jpg"); // Fallback image
          }
        }
      } catch (error) {
      ...
      <div className="px-4 sm:px-14 flex flex-col sm:flex-row gap-8">
        ...
        <div className="w-full sm:w-[506px] h-[650px] relative">
          <div className="w-full h-full rounded-lg overflow-hidden shadow-lg border border-[#E8E8E8]">
            <Image
              src={currentImage || "/path/to/fallback/image.jpg"} // Fallback image
              alt={product.name}
              layout="fill"
              objectFit="cover"
...
const handleSomething = (arg0: string) => {
  console.log("Handling something with:", arg0);
};